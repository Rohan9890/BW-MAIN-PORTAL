...
const PAYMENT_TABS = ['Credit / Debit Card', 'Net Banking', 'UPI', 'Wallet', 'More'];
        ...
        <div className="payment-layout">
          <div className="payment-left">
            <div className="plan-summary">
              <div className="plan-summary-top">
                <div className="plan-info">
                  ...
                  <div>
                    <h3>Standard Plan</h3>
                    <span className="plan-badge"><span className="star-yellow">★</span> Priority support</span>
                  </div>
                </div>
              ...
              <div className="plan-billing-row">
                ...
                <div className="total-box">
                  ...
                  <p className="save-msg">You save ₹199.50 with yearly billing!</p>
                </div>
              </div>
            </div>
            ...
            <div className="payment-details-section">
              ...
              <div className="card-form">
                <input type="text" className="input" placeholder="Card Number xxxx xxx xx xx" />
          ...
          <div className="order-summary-side">
            <div className="order-summary-box">
              ...
              <button type="button" className="btn btn-primary btn-pay-now">
                <span className="btn-cart-icon">🛒</span> Make Payment <span className="btn-amount">₹999.30</span>
              </button>
            </div>
          </div>
        </div>
