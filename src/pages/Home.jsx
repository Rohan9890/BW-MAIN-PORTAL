...
export default function Home() {
  ...
  const stats = [
    ...
    { label: "My Tickets", value: "8", icon: "🎟️" },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h1 style={{ margin: 0, fontSize: 32, color: "#102a43" }}>
            Good Morning, Rohan ??
          </h1>
      ...
      >
        ...
        >
          ...
          >
            {stats.map((stat) => (
              <div key={stat.label} style={{ ...card, minHeight: 92 }}>
                ...
                <h2
                  style={{ margin: "8px 0 0", fontSize: 28, color: "#102a43" }}
                >
                  {stat.value}
                </h2>
              </div>
            ...
            <div style={{ ...card, minHeight: 92 }}>
              ...
              <h2 style={{ margin: "8px 0 0", fontSize: 28, color: "#102a43" }}>
                67%
              </h2>
            </div>
          </div>
          ...
          >
            <div style={{ ...card }}>
              <h3 style={{ margin: 0, fontSize: 14, color: "#102a43" }}>
                Complete KYC
              </h3>
              <p style={{ margin: "8px 0", color: "#627d98", fontSize: 13 }}>
                Verify your identity for access
              </p>
              <button
          ...
          <div style={{ ...card }}>
            ...
            <div style={{ marginTop: 12, color: "#334e68", fontSize: 14 }}>
              <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                <span>??</span>
                <span>New Feature: API usage insights added</span>
              </div>
              <div style={{ display: "flex", gap: 8, marginBottom: 8 }}>
                <span>?</span>
                <span>Improved dashboard performance for faster loading</span>
              </div>
              <div style={{ display: "flex", gap: 8 }}>
                <span>?</span>
                <span>Bug Fixes: Billing and invoicing issues resolved</span>
              </div>
            </div>
          </div>
        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            >
              {usageData.map((item) => (
                <div key={item.day} style={{ flex: 1, textAlign: "center" }}>
                  <div
                    style={{
                      height: `${(item.value / maxUsage) * 100}%`,
                      background: "#2f80ed",
                      borderRadius: 6,
                      transition: "0.2s",
                    }}
            ...
            {transactions.map((tx) => (
              ...
              >
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <small style={{ color: statusColor(tx.status) }}>
                    {tx.status}
                  </small>
                </div>
              </div>
          ...
          <div style={{ ...card }}>
            <h3 style={{ margin: "0 0 8px", fontSize: 16, color: "#102a43" }}>
              Recent Activity
            </h3>
