/** @deprecated Prefer `backendApis.js` + `backendClient.js` for all API calls. */
...
// ================= DASHBOARD =================
/** @deprecated Legacy paths — use `dashboardBackend` / `dashboardApi` (`GET /dashboard`, `GET /dashboard/transactions?page=&size=`). */
